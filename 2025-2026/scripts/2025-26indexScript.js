...
// Ordered sequentially 1 through 6
let issues = [
  {
    // Issue I (index 0)
...
function openPopup(i) {
  ...
  // Safely grab the current issue profile
  ...
  // SAFE GUARD: Wrap SVG property manipulation in try-catch to bypass local CORS errors
  try {
